                        ...
                        */}
                        {(() => {
                            ...
                            if (firstGroup && allSame) {
                                return <Badge variant="outline" className="text-[10px] h-4 py-0 px-1 font-normal text-muted-foreground truncate max-w-25">{firstGroup}</Badge>
                            }
                            return null;
                        })()}
                    </div>
                                            ...
                                            <div className="flex items-center gap-3 overflow-hidden">
                                                ...
                                                <div className="flex flex-col min-w-0">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {showGroupBadge && groupName && <Badge variant="secondary" className="text-[10px] h-4 px-1 truncate max-w-20">{groupName}</Badge>}
                                                    </div>
